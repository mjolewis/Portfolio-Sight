...
public class StockBreakdownController {

    private static final FluentLogger LOGGER = FluentLoggerFactory.getLogger(StockBreakdownController.class);
    private final PortfolioService portfolioService;
    private final ResponseService responseService;
    private final UserService userService;

    public StockBreakdownController(PortfolioService portfolioService,
