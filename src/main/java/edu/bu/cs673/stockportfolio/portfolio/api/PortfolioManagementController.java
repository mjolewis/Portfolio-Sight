...
public class PortfolioManagementController {
    ...
    private static final FluentLogger LOGGER = FluentLoggerFactory.getLogger(PortfolioManagementController.class);
    private final UserService userService;
    private final PortfolioService portfolioService;
    private final ValidationService validationService;
    private final ResponseService responseService;

    public PortfolioManagementController(UserService userService, PortfolioService portfolioService,
