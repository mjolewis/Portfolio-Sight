...
public class MarketDataScheduler {
     ...
     *
     * @Note The zone must be updated to either EDT or EST. EDT is represented by UTC−4 and EST is represented by
     *         UTC−5. EST runs from March to November. It starts during the first Sunday of November until the
     *         second Sunday of March. In the second Sunday of March, clocks switch into the Eastern Daylight Time
     */
    @Scheduled(cron = "0 */1 9-16 * * MON-FRI", zone = "UTC−4")
